  ...
  apps: [
    {
      ...
      script: "/Users/filipbalaz/cortextos/dist/daemon.js",
      args: '--instance ' + (process.env.CTX_INSTANCE_ID || "default"),
      cwd: "/Users/filipbalaz/cortextos",
      env: {
        CTX_INSTANCE_ID: process.env.CTX_INSTANCE_ID || "default",
        CTX_ROOT: process.env.CTX_ROOT || "/Users/filipbalaz/.cortextos/default",
        CTX_FRAMEWORK_ROOT: "/Users/filipbalaz/cortextos",
        CTX_PROJECT_ROOT: "/Users/filipbalaz/cortextos",
        CTX_ORG: process.env.CTX_ORG || "bridgepilot",
      },
      max_restarts: 50,
      restart_delay: 5000,
      autorestart: true,
    },
    {
      ...
      script: 'npm',
      args: 'run dev',
      cwd: "/Users/filipbalaz/cortextos/dashboard",
      env: {
